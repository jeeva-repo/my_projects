    ...
    <table border="2" cellspacing="3" align="center" id="timetable">
        <caption>
            <strong><br><br>
                ...
                if (isset($_POST['select_semester'])) {
                    echo "BTECH INFORMATION TECHNOLOGY - SEMESTER " . $_POST['select_semester'] . " ";
        ...
        <tr>
            ...
            if (isset($_POST['select_semester']) && $_POST['select_semester'] % 2 !== 0) {
                ...
                echo '</table>';
                $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM,DEPARTMENT OF INFORMATION TECHNOLOGY ,AU-MIT";
                if (isset($_POST['select_semester'])) {
