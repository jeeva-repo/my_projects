...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h1 align="center">DEPARTMENT OF INFORMATION TECHNOLOGY, AU-MIT</h1>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/it_dept.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lab1.webp" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/lab2.webp" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/lab3.webp" alt="Flower">
        </div>
    </div>
</div>
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">CORE FACULTIES </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/dean.png" class="img-rounded"/>
                    <h3 align="center">PROF. J. PRAKASH</h3>
                    <hr/>
                    <h4 align="center">DEAN<br/>F/o DEPARTMENT OF INSTRUMENTATION ENGINEERING</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/principal.png" class="img-rounded"/>
                    <h3 align="center">DR. M.R. SUMALATHA</h3>
                    <hr/>
                    <h4 align="center">HEAD OF THE DEPARTMENT <br/> DEPARTMENT OF INFORMATION TECHNOLOGY</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/chairman.png" class="img-rounded"/>
                    <h3 align="center">DR. G. RAJESH</h3>
                    <hr/>
                    <h4 align="center">ASST-PROFESSOR<br/>FACULTY INCHARGE- INFORMATION TECHNOLOGY ASSOCIATION</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4><strong>Madras Institute of Technology</strong> </h4>
                <h4>Chromepet, </h4>
                <h4>Chennai, Tamilnadu </h4>
                <h4>India - 600 044</h4>
                <h4><strong>Call:</strong> 044-2251 6020</h4>
                <h4><strong>Email: </strong>aucmitit@gmail.com</h4>
            </div>
